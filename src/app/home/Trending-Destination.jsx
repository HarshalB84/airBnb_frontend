    ...
    return (
        <div className="container my-16">
            <div className="mb-4 space-y-1">
                ...
                <p className="text-base text-muted-foreground">Most popular choices for travellers in India</p>
            </div>
            <div className="grid grid-cols-6 gap-4">
                {TRENDING_DESTINATIONS.map((destination,index) => (
                    <div key={index} className={`h-[270px] rounded-lg overflow-hidden relative ${destination.className}`}>
                        ...
                        <div className="absolute from-70% to to-100% inset-0 size-full bg-gradient-to-t from-transparent to-blue-800/60">
                            <div className="p-3">
